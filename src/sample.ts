...
export const sampleClips: Clip[] = [
  {
    ...
    episodeUrl: 'https://example.com/episodes/retrieval', feedUrl: '', timestampSec: 754,
  ...
  },
  {
    ...
    episodeUrl: 'https://example.com/episodes/small-habits', feedUrl: '', timestampSec: 1118,
  ...
  },
  {
    ...
    episodeUrl: 'https://example.com/episodes/public-trust', feedUrl: '', timestampSec: 2045,
  ...
  },
  {
    ...
    episodeUrl: 'https://example.com/episodes/boundaries', feedUrl: '', timestampSec: 488,
  ...
  },
  {
    ...
    episodeUrl: 'https://example.com/episodes/stopping-rule', feedUrl: '', timestampSec: 927,
